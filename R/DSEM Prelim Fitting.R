...
# make path diagrams
par(mfrow = c(1, 2))
plot1 <- plot_qgraph_panel(df_Sciaenid, coef_matrix_AB_Sciaenid_NoLag$coef,  plot_title = "Sciaenid-AB-No Lag")
plot2 <- plot_qgraph_panel(df_Sciaenid, coef_matrix_AB_Sciaenid_YesLag$coef, plot_title = "Sciaenid-AB-1 Year Lag")
par(mfrow = c(1, 1))
...
par(mfrow = c(1, 2))
plot1 <- plot_qgraph_panel(df_Pred, coef_matrix_AB_Pred_NoLag$coef,  plot_title = "Keystone Predator-AB-No Lag")
plot2 <- plot_qgraph_panel(df_Pred, coef_matrix_AB_Pred_YesLag$coef, plot_title = "Keystone Predator-AB-1 Year Lag")
par(mfrow = c(1, 1))
...
# make path diagrams
par(mfrow = c(1, 2))
plot1 <- plot_qgraph_panel(df_Sciaenid_GB, coef_matrix_GB_Sciaenid_NoLag$coef,  plot_title = "Sciaenid-GB-No Lag")
plot2 <- plot_qgraph_panel(df_Sciaenid_GB, coef_matrix_GB_Sciaenid_YesLag$coef, plot_title = "Sciaenid-GB-1 Year Lag")
par(mfrow = c(1, 1))
